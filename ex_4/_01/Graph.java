...
***************************************************************************************/
/**
 * Graph Class will contain the main methods of a graph (Book implementation)
 * In addition , it will have a method called robustify() , which will replicate each node 
 * and its respective edges three times 
 */
...
public class Graph {
	 ...
	 * In the 2-nd case , two connections will be added into the robust[i][j] Bag (line-48 , line 74)
	 * 
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Out out = new Out("simple.txt");  //output file
		

		out.println(G.toFile(G));   // printing the simple graph in the file
		G.robustify(); 				// robustifying the graph 
		
		Out out2 = new Out("robustified.txt"); //output file
		out2.println(G.toFile(G));	// printing the robustified graph in the file
